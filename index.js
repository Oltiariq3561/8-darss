...
//   return array;
// }
// console.log(juftSonlarYoq(arr));

// 7-masala

// let arr = [7,2,1,4,12];
// function toqSonlarYoq(array) {
//   for (let i = 0; i < array.length; i++) {
// if (array[i] % 2 == 1) {
//   array[i] = null
// }
